...
wget https://repo.zabbix.com/zabbix/5.4/ubuntu/pool/main/z/zabbix/zabbix-agent_5.4.9-1+ubuntu18.04_amd64.deb

dpkg -i zabbix-agent_5.4.9-1+ubuntu18.04_amd64.deb
