...
wget https://repo.zabbix.com/zabbix/5.4/debian/pool/main/z/zabbix/zabbix-agent_5.4.10-1+debian10_amd64.deb 

dpkg -i zabbix-agent_5.4.10-1+debian10_amd64.deb 
